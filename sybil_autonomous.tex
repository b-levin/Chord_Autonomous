...
%TODO:
% Abstract, motivation, Introduction, merge with IEEE paper, add other authors
% brief background on early sybil attacks
...
{We suspect the worse runtime factors in homogeneous networks don't necessarily imply the method is weaker.
	...
	This speedup is reflected in the average number of tasks consumed in a tick, shown in  \ref{fig:churnVsWork}.
